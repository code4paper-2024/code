...
# parser.add_argument("-a",'lora_weights', type=str)
# parser.add_argument("-b",'test_file', type=str)
# parser.add_argument("-c",'output_file', type=str)
# parser.add_argument("-d",'max_new_tokens', type=int)

# args = parser.parse_args()
import sys
# lora_weights, test_file, output_file, max_new_tokens = sys.argv[1:5]

load_8bit: bool = False
base_model= 'meta-llama/Llama-2-7b-hf'
lora_weights: str = sys.argv[1]
test_file = sys.argv[2]
output_file = sys.argv[3]
max_new_tokens = 1
twolists = ["/home/qianzy/LLaMA-LoRA-Tuner/moe_test/FB15K-2.json", "/home/qianzy/LLaMA-LoRA-Tuner/moe_test/nell-2.json", "/home/qianzy/LLaMA-LoRA-Tuner/moe_test/wiki-2.json"]
if(test_file in twolists):
    max_new_tokens = 2
perturbation_times = 3
...
class Prompter(object):
    ...
    def __init__(self, template_name: str = "", verbose: bool = False):
        ...
        file_name = f"/home/qianzy/LLaMA-LoRA-Tuner/data/templates/{template_name}.json"
